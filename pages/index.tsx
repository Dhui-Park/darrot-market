...
const Home: NextPage = () => {
  return (
    <div className="grid min-h-screen gap-10 bg-slate-400 py-20 px-20  lg:grid-cols-2  xl:grid-cols-3 xl:place-content-center ">
      <div className="flex flex-col justify-between rounded-3xl bg-white p-6 shadow-xl sm:bg-teal-100 md:bg-teal-200 lg:bg-teal-300 xl:bg-teal-400 2xl:bg-teal-500">
      ...
      <div className="group overflow-hidden rounded-3xl bg-white shadow-xl">
        <div className="p-6 pb-14 xl:pb-40 portrait:bg-teal-300 landscape:bg-indigo-300">
        ...
        <div className="relative -top-5 rounded-3xl bg-white p-6">
          <div className="relative -top-16 flex items-end justify-between">
            ...
            <div className="h-24 w-24 rounded-full bg-zinc-300 group-hover:bg-red-300" />
            <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-5">
              <button className=" flex aspect-square w-8 items-center justify-center rounded-lg bg-blue-200 text-xl text-gray-500"></button>
              <span>1</span>
